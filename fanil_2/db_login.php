...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['login'])) {
    ...
    if ($result) {
        ...
        if ($user_matched > 0) {
            ...
            header("location: final project CIS201.html");
        } else {
            $error_message = "User email or password is not matched";
        }
    } else {
...
<div class="bar">
    ...
    <div class="form-container">
        ...
        <form action="db_login.php" method="post" name="form1">
            <table>
                <tr>
                    <td>Email</td>
        ...
        if (!empty($error_message)) {
            ...
            echo "<p>Don't have an account? <a href='db_register.php'>Register</a></p>";
        }
        ?>
    </div>
<script>
